...
public class StringEx {
	...
	private static void stringFormatEx() {
		...
		String fmt = "%d개의 %s 중에서 %d개를 먹었다%n";	//	포멧을 미리 생성
		String result = String.format(fmt, 5, "바나나", 2);	//	필요할 때 데이터 연결
	...
	private static void stringBasic() {
		...
		//	참조 변수의 ==, !=은 주소를 비교하는 것
		//	Literal vs Literal -> String Pool에서 관리
		...
		System.out.println("str2과 str3가 내용이 같은가?" + str.equals(str3));
