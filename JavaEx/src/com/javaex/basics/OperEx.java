...
public class OperEx{
	...
	private static void conditionalOper() {
		...
		//	a가 짝수(2의 배수)면 짝수라고 출력, 아니면 홀수라고 출력
		String message;
	...
	private static void bitOper() {
		...
		int result = b1 & b2;	//	비트 논리 곱 : 둘다 1이어야 1비트로 세팅됨
		System.out.println("b1&b2: " + Integer.toBinaryString(result));
		result = b1 | b2;		//	비트 논리 합: 둘 중 한 개만 1이면 1비트 세팅됨
		System.out.println("b1|b2: " + Integer.toBinaryString(result));
	...
	private static void logicOper() {
		...
		System.out.println("a와 b가 같지 않은가? " + (n1 != n2));
		...
		System.out.println("n3가 0초과 10 미만 영역에 있는가? " + r1andr2);
