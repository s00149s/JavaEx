...
//		sortCustomEx();
	...
	private static void searchEx() {
		...
		System.out.println("정렬된 원본 : " + Arrays.toString(str));
	...
	private static void sortCustomEx() {
		...
		System.out.println("원본 : " + Arrays.toString(members));
		Arrays.sort(members);
		System.out.println("정렬 : " + Arrays.toString(members));		//	오름차순 정렬
	...
	private static void sortEx() {
		...
		System.out.println("원본 : " + Arrays.toString(nums2));
		
		//	정렬(내림차순)
		Arrays.sort(nums2, Collections.reverseOrder());
		System.out.println("정렬 후(내림차순) : " + Arrays.toString(nums2));
	...
	private static void copyArrayEx() {
		...
		//	방법 4. Arrarys.copyOfRange(부분 복사)
	...
	private static void printArrayEx() {
		...
		//출력
		System.out.println(arr); 	// 배열의 주솟값 출력
