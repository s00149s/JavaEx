...
public class WrapperEx {
	...
	public static void main(String[] args) {
		...
		//	자동 박싱
		Integer i2 = 2021;	//	Integer i2 = Integer.valueOf(2021);이 자동으로 생성된 것
		
		//	parse계열 메서드
		System.out.println(Integer.parseInt("-123"));	//	문자열 -> 정수 변환
		System.out.println(Integer.parseInt("FF", 16));	//	16진수 문자열 -> 16진수 정수 변환
		System.out.println(Integer.toBinaryString(2021));	//	2진수 문자열변환
